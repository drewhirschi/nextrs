...
fn template_files(
    ...
    vec![
        ...
        ("client/scripts/gen-barrel.mjs", gen_barrel_mjs()),
...
fn client_package_json(crate_name: &str) -> String {
  ...
  "scripts": {{
    ...
    "gen": "npm run dump && npm run orval && npm run barrel",
...
// scripts, and tests. `npm run gen` keeps ./generated/index.ts current, so
// new endpoints show up here without editing this file.
export * from "./generated";
"#
    .into()
}

fn gen_barrel_mjs() -> String {
    r#"// Regenerate src/generated/index.ts after orval runs, so every generated
...
mod tests {
    ...
    fn templates_use_react_first_conventions() {
        ...
        let package_json = files
            ...
            .1
            .as_str();
        assert!(package_json.contains(r#""gen": "npm run dump && npm run orval && npm run barrel""#));
        assert!(package_json.contains(r#""orval": "^7.3.0""#));

        // The client package index re-exports the generated barrel wholesale —
        // a hand-maintained list of generated modules goes stale.
        let index = files
            .iter()
        ...
        let barrel = files
            .iter()
            .find(|(name, _)| *name == "client/scripts/gen-barrel.mjs")
            .unwrap()
            .1
            .as_str();
        assert!(barrel.contains("src/generated/"));
