...
// `__nx_seeds__` prefix; the shell's router reads the URL and renders the leaf,
// keeping shared layouts mounted across soft navigation. Keep this name in sync
// with the "__app_shell__" input name in bundle.rs.
...
</script><script type="module" src="/dist/__app_shell__.js"></script>"#,
        tsx_document_head()
    )
}
