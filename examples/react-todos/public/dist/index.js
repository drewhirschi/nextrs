...
//#endregion
//#region src/generated/todos/todos.ts
/**
...
const getTodos = async (params, options) => {
...
const getGetTodosQueryKey = (params) => {
	return [`/api/todos`, ...params ? [params] : []];
};
const getGetTodosQueryOptions = (params, options) => {
	const { query: queryOptions, fetch: fetchOptions } = options ?? {};
	const queryKey = queryOptions?.queryKey ?? getGetTodosQueryKey(params);
	const queryFn = ({ signal }) => getTodos(params, {
		signal,
		...fetchOptions
	});
	return {
...
function useGetTodos(params, options, queryClient) {
...
const addTodo = async (addTodoRequest, options) => {
...
const getAddTodoMutationOptions = (options) => {
...
const useAddTodo = (options, queryClient) => {
	return useMutation(getAddTodoMutationOptions(options), queryClient);
};
const getDeleteTodoUrl = (id) => {
	return `/api/todos/${id}`;
};
const deleteTodo = async (id, options) => {
...
const getDeleteTodoMutationOptions = (options) => {
...
const useDeleteTodo = (options, queryClient) => {
...
function Todos() {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { children: [
		...
		/* @__PURE__ */ (0, import_jsx_runtime.jsx)("ul", {
			className: "list",
			children: todos?.data.map((t) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("li", { children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { children: t.title }), /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", {
				className: "ghost",
...
//#endregion
//#region ../../../target/debug/build/react-todos-984ec88d560e5cbe/out/nextrs_tsx/index.tsx
...
(0, import_client.createRoot)(document.getElementById("__nx_root__")).render(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(QueryClientProvider, {
	client: qc,
	children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Todos, {})
}));
