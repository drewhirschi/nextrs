...
/// Typed bindings for React islands referenced from RSX pages
/// (`components/TodoStats.tsx` → `client::TodoStats`), generated by
/// `bundle_pages` from each island's TypeScript props interface.
pub mod client {
    include!(concat!(env!("OUT_DIR"), "/nextrs_islands.rs"));
}
